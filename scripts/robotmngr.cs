...
{
    public Transform leftArm, rightArm, armor_part_1, armor_part_2, armor_part_4, armor_part_5, armor_part_6, head, legs;
    ...
    public GameObject assemblyCompleteText;
    ...
    void Start()
    {
        ...
        interactableObjects = new Transform[] {
            leftArm, rightArm, armor_part_1, armor_part_2, armor_part_4,
            armor_part_5, armor_part_6, head, legs
        };
        ...
        for (int i = 0; i < interactableObjects.Length; i++)
        {
            ...
            explodedPositions[i] = originalPositions[i] + new Vector3((i - 4) * 0.4f, 0, 0);
        ...
        if (hintText != null)
            hintText.text = "Drag the parts and start the assembling process";
    ...
    {
        foreach (bool assembled in isPartAssembled)
        {
            if (!assembled)
                return false;
        }
    ...
    void UpdateProgress()
    {
        ...
        if (statusText != null)
        {
            ...
            {
                statusText.text = "Congratulations!!,You have successfully assembled the robot";
            }
        }
